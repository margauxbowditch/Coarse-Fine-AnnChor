...
FINE_FEAT_DIR = '/home/margauxb/Coarse-Fine-AnnChor/fine_spatial7x7' # pre-extract fine features and save here, to reduce compute req
...
def run(init_lr=INIT_LR, warmup_steps=0, max_epochs=200, root=CHARADES_ROOT, train_split=CHARADES_ANNO,
    ...
    save_model = '/home/margauxb/Coarse-Fine-AnnChor/models/coarse_fineFEAT_annchor_'
    ...
    if steps>0:
        load_ckpt = torch.load('/home/margauxb/Coarse-Fine-AnnChor/models/coarse_fineFEAT_annchor_'+str(load_steps).zfill(6)+'.pt')
    ...
    val_apm = APMeter()
    tr_apm = APMeter()
    write_file = open('/home/margauxb/Coarse-Fine-AnnChor/localize_corr_v1.csv', 'w', newline='\n')
    writer = csv.writer(write_file)

    coarsefineTrainLog = open('/home/margauxb/Coarse-Fine-AnnChor/coarseFineTrainingLog.txt', 'a')
                ...
                if num_iter == num_steps_per_update and phase == 'train':
                    ...
                    if steps % s_times == 0:
                        ...
                        if tr_map > best_tr_map:
                            ...
                            torch.save(ckpt, "/home/margauxb/Coarse-Fine-AnnChor/models/best_model_tr_map.pt")
            ...
            if phase == 'val':
                ...
                if val_map > best_val_map:
                    ckpt = {'epochs': epochs + 1,
                            ...
                            'optimizer_state_dict': optimizer.state_dict(),
                            'scheduler_state_dict': lr_sched.state_dict()}
                    torch.save(ckpt, "/home/margauxb/Coarse-Fine-AnnChor/models/best_model_val_map.pt")
