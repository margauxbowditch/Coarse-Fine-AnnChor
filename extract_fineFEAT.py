...
FINE_SAVE_DIR = '/home/margauxb/Coarse-Fine-AnnChor/fine_spatial7x7'
...
def run(init_lr=INIT_LR, warmup_steps=0, max_epochs=100, root=CHARADES_ROOT,
    ...
    load_ckpt = torch.load('/home/margauxb/Coarse-Fine-AnnChor/models/fine_annchor_.pt') #to be updated
